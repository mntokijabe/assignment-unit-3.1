...
let favoriteFoods = ['pizza', 'samosas', 'banana cream pie', 'Sr Store donuts'];
...
console.log('Number of favorite foods:', numberOfFoods);  //displaying the number of foods
...
console.log('The second animal is',secondAnimal);  //shows the second animal
...
let dessert = 'Chocolate Peanut Butter Pie';
favoriteFoods.push(dessert);
console.log('Added another dessert to the end,', favoriteFoods);
